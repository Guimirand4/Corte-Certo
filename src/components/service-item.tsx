...
const ServiceItem = ({ service, barbershop }: ServiceItemProps) => {
  ...
  const handleBookingSheetOpenChange = () => {
    ;(setselectedDay(undefined), setSelectedTime(undefined), setDayBookings([]))
              ...
              >
                ...
                <SheetContent className="px-0">
                  <div className="flex flex-col items-center px-5">
                    <SheetHeader className="flex justify-end px-5">
                  ...
                  <div
                    className={`flex gap-3 overflow-x-auto border-b border-solid p-5 px-5 [&::-webkit-scrollbar]:hidden ${
                      timeList.length === 0 ? "items-center justify-center" : ""
                    }`}
                  >
                    {timeList.length > 0 ? (
                      timeList.map((time) => (
